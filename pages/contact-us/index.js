...
export default function ContactUs() {
  ...
  return (
    <>
    <Head>
      <title>Contact Us | Hitecheagle</title> 
        <meta
          name="description"
          content="Thank you for your interest in our tech website. We value your feedback, inquiries, and suggestions. Please use the following contact information to get in touch with us:"
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:url" content="https://www.hitecheagle.com/contact-us" />
        <link rel="canonical" href="https://www.hitecheagle.com/contact-us" />
      ...
      <Banner title="Conatct Us" image="/images/contact-us.jpeg" />
      <section className="relative z-10 px-4 lg:px-10 overflow-hidden bg-white py-20 lg:py-[120px]">
          ...
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="text-dark mb-6 text-[32px] font-bold sm:text-[40px] font-sohne_700 lg:text-[36px] xl:text-[40px]">
                  Get in touch with us
                </h2>
                <p className="text-body-color mb-9 text-base leading-relaxed">
                  Thank you for your interest in our tech website. We value your feedback, inquiries, and suggestions. Please use the following contact information to get in touch with us:
                </p>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div>
                    <input
                      type="submit"
                      value="Send Message"
                      className="bg-main cursor-pointer border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                    />
                  </div>
                  <p className="text-main mt-2">{res === '200' ? 'Email Sended' : res === 'true' && 'Sending...'}</p>
                </form>
                <div>
